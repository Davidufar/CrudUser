...
public class PassportController {
    ...
    public ResponseEntity<HttpStatus> addPassport(@RequestBody Passport passport){return passportService.addPassport(passport);
    }

    @PostMapping("/{id}")
    public ResponseEntity<HttpStatus> updatePassportById(@PathVariable long id,@RequestBody Passport newPassportData ){return passportService.updatePassportById(id, newPassportData);
    }
    @DeleteMapping("/{id}")
